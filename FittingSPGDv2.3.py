...
##Plot out mapC1
plt.plot(nXaxis, picoampsC1[0:15000], color='red')
##Plot out mapC2
plt.plot(nXaxis, picoampsC2[0:15000], color='orange')
##Plot out mapI1
plt.plot(nXaxis, picoampsI1[0:15000], color='teal')
##Plot out mapI2
plt.plot(nXaxis, picoampsI2[0:15000], color='purple')
plt.title('SPGD Detectors Testing Lineup In PicoAmps ')
plt.xlabel('seconds')
plt.ylabel('Picoamps ')
plt.savefig("Rx Power Lineup SPGD In PicoAmps.svg")
plt.savefig("Rx Power Lineup SPGD In PicoAmps.png")
plt.grid()
plt.show()
...
##Plot out mapC1
plt.plot(xAxis, mapC1[0:19000], color='red')
##Plot out mapC2
plt.plot(xAxis, mapC2[0:19000], color='orange')
##Plot out mapI1
plt.plot(xAxis, mapI1[0:19000], color='teal')
##Plot out mapI2
plt.plot(xAxis, mapI2[0:19000], color='purple')
plt.title('SPGD Detectors Testing Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.savefig("Rx Power Lineup SPGD Post Map.svg")
plt.savefig("Rx Power Lineup SPGD Post Map.png")
plt.grid()
plt.show()
