# -*- coding: utf-8 -*-
"""
Created on Sat Oct 13 19:56:17 2018

@author: Jacob Miske
"""


#Fitting Test Plan 3 SPGDs from TREAT nuclear reactor at Idaho National Labs
...
#read a txt
CEA_txt_file = r"Test_Plan_3_2018_1.txt"
...
plt.title('CEA SPGD Raw Detector Data Plan 3')
plt.xlabel('Data Points'); plt.ylabel('Picoamperes'); plt.legend()
plt.savefig('CEA TP3 Raw Data.svg')
plt.grid()
plt.show()
...
plt.title('CEA SPGD Filtered Detector Data Plan 3')
plt.xlabel('Data Points'); plt.ylabel('Picoamperes'); plt.legend()
plt.savefig('CEA TP3 Filtered Data.svg')
plt.grid()
plt.show()
...
plt.title('SPGD Detectors TP3 Testing Lineup In PicoAmps ')
plt.xlabel('seconds')
plt.ylabel('Picoamps '); plt.legend()
plt.savefig("Rx Power TP3 Lineup SPGD In PicoAmps.svg")
plt.savefig("Rx Power TP3 Lineup SPGD In PicoAmps.png")
plt.grid()
plt.show()
...
plt.title('SPGD Detectors TP3 Testing Lineup Post Map '); plt.legend()
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power TP3 Lineup SPGD Post Map.svg")
plt.show()
...
plt.title('SPGD Detectors TP3 Testing S1 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S1 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 2
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S2 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S2 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 3
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S3 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S3 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 4
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S4 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S4 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 5
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S5 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S5 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 6
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S6 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S6 TP3 Lineup SPGD Post Map.svg")
plt.show()
###Section 7
##Plot out mapC1
...
plt.title('SPGD Detectors TP3 Testing S7 Lineup Post Map ')
plt.xlabel('seconds')
plt.ylabel('Kilowatts ')
plt.grid()
plt.savefig("Rx Power S7 TP3 Lineup SPGD Post Map.svg")
plt.show()
